...
plt.loglog(omega, NRayFEM_solu_err1, label=r'$\Vert u_{\mathbf{d}_{\widetilde{\omega}}} - u_{ex}\Vert_{L^2(\Omega)} $',
           color='b', linewidth=2, linestyle='--', marker='.', markersize=8.0, zorder=2)

plt.loglog(omega, NRayFEM_solu_err2, label=r'$\Vert u_{\mathbf{d}_{\omega}} - u_{ex}\Vert_{L^2(\Omega)}$',
...
plt.loglog(omega, NRayFEM_solu_err2[0]/(omega/(omega[0])), label=r'$\mathcal{O}(\omega^{-1})$', color='g', linewidth=2, linestyle='solid', markersize=8.0, zorder=2)
