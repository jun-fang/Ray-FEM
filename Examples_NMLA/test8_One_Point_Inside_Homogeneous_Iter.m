...
subplot(2,2,3);
mapto_polar(node,elem,omega,speed,v2,numray2,xs,ys,r1,r2,theta1,theta2,u2,'spline');

subplot(2,2,2);
mapto_polar(node,elem,omega,speed,ve,ray,xs,ys,r1,r2,theta1,theta2);

subplot(2,2,4);
mapto_polar(node,elem,omega,speed,ve,ray,xs,ys,r1,r2,theta1,theta2,ue,'spline');
