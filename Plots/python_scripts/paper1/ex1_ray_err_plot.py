...
p3, = plt.loglog(omega, 0.85*ray_err2[0]/(omega/(omega[0])), label=r'$\mathcal{O}(\omega^{-1})$', color='r', linewidth=2, linestyle='solid', markersize=8.0, zorder=2)

first_legend = plt.legend(handles=[p1, p2], loc=1, ncol=1, frameon=False, fontsize=18)
ax = plt.gca().add_artist(first_legend)
plt.legend(handles=[p3], loc=3, ncol=1, frameon=False, fontsize=18)
