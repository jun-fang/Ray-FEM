...
p2, = plt.loglog(omega, ERayFEM_solu_err[0]*1.03/(omega/(omega[0])), label=r'$\mathcal{O}(\omega^{-1})$', color='r', linewidth=2, linestyle='solid', markersize=8.0, zorder=2)
...
plt.legend(handles=[p2], loc=3, ncol=3, frameon=False, fontsize=22)
...
fig.savefig('ex1_Exact_Ray_FEM_solu_err_plot.pdf')
plt.show()
