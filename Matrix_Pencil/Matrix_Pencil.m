function [z] = Matrix_Pencil(y, tol, L)
%%  Matrix Pencil Method fits a sum of exponential functions: 
%
%	[z] = Matrix_Pencil(y, tol, L) approximates y(i) by a weighted sum of
%	exponentials sum_{j=1}^p  A(j)*exp(B(j)*X(i)). The X(i) are assumed 
%   equally spaced.
%
% The number of exponential is defined with the second optional
