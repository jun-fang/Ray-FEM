%% Two point sources outside domain problem
% 
...
pde = MPM_data3_0;                  % one point source pde structure
Nray = 3;                         % one ray direction at every grid point
...
save('3points.mat','rec_omega','rec_err1','rec_err2','rec_err3','rec_err4',...
