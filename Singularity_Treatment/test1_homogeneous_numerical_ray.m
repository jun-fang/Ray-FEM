...
fprintf(fileID,'\n\n Point source problem in homogeneous medium: \n\n');
fprintf(fileID,'u_ex = sqrt(k)*besselh(0,1,k*sqrt((x-xs)^2 + (y-ys)^2)) \n\n');
...
% lg_a = 5/4; md_a = 3/4; sm_a = 1/2;

lg_a = 3/2; md_a = 7/8; sm_a = 1/2;
epsilon = 0.113;
Rest = 1;
NPW = 6;

cp_omega = [40 80 160]*2*pi;
