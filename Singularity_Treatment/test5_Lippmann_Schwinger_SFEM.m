...
% SFEM rel l2 err:     &  6.95e-01  &  4.81e-01  &  3.44e-01  &  2.57e-01  &  1.98e-01  
% --------------------------------------------------------------------------------

figure(12);
subplot(1,3,1);
showsolution(node,elem,real(uex),2);colorbar;
title('LipSch Reference solu: 120pi');

subplot(1,3,2);
showsolution(node,elem,real(us),2);colorbar;
title('LipSch SFEM solu: 120pi, NPW = 40');

subplot(1,3,3);
showsolution(node,elem,real(ddu),2);colorbar;
title('LipSch SFEM error: 120pi, NPW = 40');
