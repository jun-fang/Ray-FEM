...
figure(1);
subplot(3,2,1);
showrate(rec_omega(1:n),ray_maxerr);
subplot(3,2,2);
showrate(rec_omega(1:n),ray_l2err);
subplot(3,2,3);
showrate(rec_omega(1:n),nr_maxerr);
subplot(3,2,4);
showrate(rec_omega(1:n),nr_l2err);
subplot(3,2,5);
showrate(rec_omega(1:n),er_maxerr);
subplot(3,2,6);
showrate(rec_omega(1:n),er_l2err);
